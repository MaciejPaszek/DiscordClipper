namespace DiscordClipper
{
    partial class FormSettings
    {
        ...
        private void InitializeComponent()
        {
            ...
            label13 = new Label();
            numericUpDownVideoBitrateLimit = new NumericUpDown();
            checkBoxVideoBitrateLimitEnabled = new CheckBox();
            ...
            ((System.ComponentModel.ISupportInitialize)numericUpDownVideoBitrateLimit).BeginInit();
            ...
            tableLayoutPanel8.Controls.Add(numericUpDownVideoBitrateLimit, 0, 0);
            tableLayoutPanel8.Controls.Add(checkBoxVideoBitrateLimitEnabled, 2, 0);
            ...
            label13.Text = "kbit/s";
            // 
            // numericUpDownVideoBitrateLimit
            // 
            numericUpDownVideoBitrateLimit.Dock = DockStyle.Top;
            numericUpDownVideoBitrateLimit.Location = new Point(3, 3);
            numericUpDownVideoBitrateLimit.Maximum = new decimal(new int[] { 12000, 0, 0, 0 });
            numericUpDownVideoBitrateLimit.Minimum = new decimal(new int[] { 1000, 0, 0, 0 });
            numericUpDownVideoBitrateLimit.Name = "numericUpDownVideoBitrateLimit";
            numericUpDownVideoBitrateLimit.Size = new Size(60, 23);
            numericUpDownVideoBitrateLimit.TabIndex = 11;
            numericUpDownVideoBitrateLimit.TextAlign = HorizontalAlignment.Right;
            numericUpDownVideoBitrateLimit.Value = new decimal(new int[] { 2500, 0, 0, 0 });
            // 
            // checkBoxVideoBitrateLimitEnabled
            // 
            checkBoxVideoBitrateLimitEnabled.AutoSize = true;
            checkBoxVideoBitrateLimitEnabled.Checked = true;
            checkBoxVideoBitrateLimitEnabled.CheckState = CheckState.Checked;
            checkBoxVideoBitrateLimitEnabled.Dock = DockStyle.Top;
            checkBoxVideoBitrateLimitEnabled.Location = new Point(148, 5);
            checkBoxVideoBitrateLimitEnabled.Margin = new Padding(3, 5, 3, 3);
            checkBoxVideoBitrateLimitEnabled.Name = "checkBoxVideoBitrateLimitEnabled";
            checkBoxVideoBitrateLimitEnabled.Size = new Size(97, 19);
            checkBoxVideoBitrateLimitEnabled.TabIndex = 13;
            checkBoxVideoBitrateLimitEnabled.Text = "Zastosuj limit";
            checkBoxVideoBitrateLimitEnabled.UseVisualStyleBackColor = true;
            checkBoxVideoBitrateLimitEnabled.CheckedChanged += checkBoxLimitBitrate_CheckedChanged;
            // 
            // groupBox4
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)numericUpDownVideoBitrateLimit).EndInit();
        ...
        private NumericUpDown numericUpDownVideoBitrateLimit;
        private CheckBox checkBoxVideoBitrateLimitEnabled;
    }
}